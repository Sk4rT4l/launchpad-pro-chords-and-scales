...
SOURCES += src/app.c src/mode/handler.c src/mode/note.c src/music/chord.c src/music/scale.c src/utils/buttons.c src/utils/colors.c src/utils/global.c src/utils/layout.c src/utils/midi.c
